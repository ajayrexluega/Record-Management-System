...
<table id='table12'>
                ...
                <tbody>
                    <tr id="clickrow" ng-repeat="inventory in data | filter:searchFilter" ng-class="{'hapitna' : inventory.available_stocks <= 10}">
            ...
            <div class="foo"></div><p class="foo2"> - re-ordering level of stocks.</p>
...
<div id="dlgbox">
    ...
    <form id="inventory" method="post" action="../php/updateInventoryList.php">
      <input type="text" name="product_id" id="id" ng-model="selectedProduct.product_id" hidden readonly><br/>
         ...
         Available Stocks<input type="text" name="available_stocks" id="astock" ng-model="selectedProduct.available_stocks" onkeypress="return event.charCode === 0 || /\d/.test(String.fromCharCode(event.charCode));"><br/>
