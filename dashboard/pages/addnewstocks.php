...
<div ng-controller="updatestocksController">
    <div id='table-scroll'>
...
<table id='table12'>
                ...
                <tbody>
                    <tr id="clickrow" ng-click="showInEdit(product)" ng-repeat="product in data | filter:searchFilter">
                        ...
                        <td><a class="click" ng-click="showInEdit(product)">{{product.available_stocks}}</td>
...
<div id="dlgbox">
    <div id="dlg-header" ><h3>Add Stocks to Inventory</h3>
    ...
    <form id="products" method="post" action="../php/updateStocksToInventory.php">
      <input type="text" name="product_id" id="id" ng-model="selectedProduct.product_id" hidden readonly><br/>
         ...
         Available Stocks<input type="text" name="available_stocks" id="price" ng-model="selectedProduct.available_stocks" readonly required><br/>
         Description<input type="text" name="description" id="description" ng-model="selectedProduct.description" readonly required><br />
         Quantity to Add<input type="text" class="addQuantity" name="stock_in" id="quantity" onkeypress="return event.charCode === 0 || /\d/.test(String.fromCharCode(event.charCode));" ng-model="quantity" autocomplete="off" required><br/>
