...
<div id="dlgbox">
    ...
    <form id="productsales" method="post" action="../php/purchasedItemFromSupplier.php">
      ...
      <a id="proceed" href="#/suppliersales">Back</a>
            ...
            if(total <= cash){
               ...
               $.ajax({
                           ...
                           success: function(data){
                            ...
                            window.location.replace("#/proceedsupplier");
                                    $('#getdata').html(data);
                            }
